				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="cart.html" class="active"><i class="fa fa-shopping-cart"></i> Keranjang</a></li>
					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="images/menu/Hamburger.jpg" alt=""></a>
							</td>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="images/menu/BigBurger.jpg" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Big Burger</a></h4>
								<p>Web ID: 1089</p>
							</td>
							<td class="cart_price">
								<p>$59</p>
		...
		<div class="container">
			<div class="heading">
				<h3>What would you like to do next?</h3>
					<p>Gunakan Kode Kupon Atau Voucher Untuk Mendapatkan Diskon atau Promo Tambahan</p>
				</div>
			<div class="row">
				<div class="col-sm-6">
					<div class="chose_area">
						...
						<a class="btn btn-default check_out" href="cart.html">Gunakan</a>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li>Sub Total <span>$118</span></li>
							<li>Shipping <span>Free</span></li>
							<li>Pajak <span>Free</span></li>
							<li>Total <span>$118</span></li>
						</ul>
